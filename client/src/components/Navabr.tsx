...
const Navbar: React.FC = () => {
	...
	return (
		<>
			<header className="mob-header gap-4 absolute flex justify-around items-center md:hidden w-full px-6 py-5 border-b-[1px] border-neutral-800 z-10">
			...
			<div className="mobile-nav absolute flex justify-between items-center md:flex-col md:left-0 md:top:0 md:h-full md:w-fit  md:border-r-[1px] border-gray-800 bottom-0 w-full lg:pl-5 lg:pr-24 md:px-6 px-8 py-3 text-2xl border-t-[1px]  z-10">
